...
```json
{
  "mcpServers": {
    "lawmatics": {
      ...
      "env": {
        "LAWMATICS_API_TOKEN": "<YOUR_LAWMATICS_API_TOKEN>"
      }
    }
  }
}
...
- Open an issue on [GitHub](https://github.com/uselawmatics/mcp-server-lawmatics/issues)
- Ask for help in the community [Slack](https://lawmatics.com/join-slack)
   ...
   ```json
   {
     "mcpServers": {
       "lawmatics": {
         "command": "node",
         "args": [
           "/path/to/your/local/mcp-server-lawmatics/dist/index.js"
         ],
         "env": {
           "LAWMATICS_API_TOKEN": "<YOUR_LAWMATICS_API_TOKEN>"
         }
