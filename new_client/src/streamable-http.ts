...
import { InitializeRequestSchema, type JSONRPCError } from "@modelcontextprotocol/sdk/types.js";
 ...
 * @param port The port to listen on (default: 3005)
 * @returns The Hono app instance
 */
export async function setupStreamableHttpServer(server: Server, port = 3005) {
	// Create Hono app
	const app = new Hono();
